...
import json
import uuid
import fhirclient.r4.models.patient as patient
import fhirclient.r4.models.specimen as specimen
import fhirclient.r4.models.codeableconcept as codeableconcept
import fhirclient.r4.models.coding as coding
import fhirclient.r4.models.fhirreference as fhirreference
from fhirclient.r4 import client
...
def getsmart():
    ...
    settings = {
        'app_id': 'my_web_app',
        'api_base': 'http://fhirtest.b12x.org/r4'
    }
...
def main():
    ...
    mypatient = getpatient('5354', getsmart())
